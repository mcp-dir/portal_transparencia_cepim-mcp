...
Portal da Transparência: Cadastro de Entidades Privadas sem Fins Lucrativos Impedidas (CEPIM) usa um único endpoint público (`https://api.mcp.ai/p_portal_transparencia_cepim`).
